...
#define GPIO_RX_PORT GPIOB
#define GPIO_RX_PIN LL_GPIO_PIN_5
#define RX_EXTI_LINE	LL_EXTI_LINE_5
#define RX_EXTI_CONFIG_PORT	LL_EXTI_CONFIG_PORTB
#define RX_EXTI_CONFIG_LINE LL_EXTI_CONFIG_LINE5
